...
/* ---------- boot ---------- */
(async function boot() {
  console.log('%c[AI GM] build ' + BUILD + ' — authDomain=firebaseapp.com (fixes redirect_uri_mismatch); open the app from that domain', 'color:#9cc29c');
